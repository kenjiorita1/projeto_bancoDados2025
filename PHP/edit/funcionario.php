...
<body>
       ...
       <main class="main-container">
        <?php foreach ($resultFuncionarios as $row) { ?>
        <div class="card">
            <h1 class="page-title">Editar Funcionário #<?= $row['matricula'] ?></h1>
            
            <form action="../update/funcionario.php" method="POST">
                <input type="hidden" name="id" value="<?= $row['id'] ?>">

                <div class="form-row">
                    <div class="form-group employee-id">
                        <label for="matricula" class="form-label">Nº Matrícula</label>
                        <input type="text" class="form-control" id="matricula" name="matricula" 
                               value="<?= htmlspecialchars($row['matricula']) ?>" required>
                    </div>
                ...
                <div class="form-row">
                    <div class="form-group position-input">
                        ...
                        <input type="text" class="form-control" id="cargo" name="cargo" 
                               value="<?= htmlspecialchars($row['cargo']) ?>" required>
                    </div>
                ...
                <div class="form-actions">
                    ...
                    <button type="submit" class="btn btn-afll">
                        <i class="fas fa-user-edit"></i> Atualizar Funcionário
                    </button>
                </div>
            </form>
        </div>
